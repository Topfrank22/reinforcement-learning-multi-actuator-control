function [meanAccuracy, stdAccuracy, allAccuracies] = evaluate_curriculum(env, agent, nEpisodes)
%EVALUATE_CURRICULUM Calcola la Sorting Accuracy su N episodi.
%
%  Identica a evaluate_agent.m ma funziona con RL_curriculum_env.
...
fprintf('\n--- Valutazione Sorting Accuracy (%d episodi, %d pacchi) ---\n', ...
