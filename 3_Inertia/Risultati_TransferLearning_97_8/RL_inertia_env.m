        ...
        function [Observation,Reward,IsDone,Info] = step(this,Action)
            ...
            for ii=1:this.n_boxes_tot
                ...
                if this.i_box(ii) < 6
                    ...
                    % Sul treadmill: anche qui il motore ha inerzia
                    this.vx_boxes(ii) = this.vx_boxes(ii) + alpha * (0 - this.vx_boxes(ii));
                    this.vy_boxes(ii) = this.vy_boxes(ii) + alpha * (this.v_treadmill - this.vy_boxes(ii));
                    this.x_boxes(ii) = this.x_boxes(ii) + this.vx_boxes(ii) * this.dt;
                    this.y_boxes(ii) = this.y_boxes(ii) + this.vy_boxes(ii) * this.dt;
                end
